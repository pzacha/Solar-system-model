    ...
    for i in range(globals.iter_num):
        ...
        if anim_iter == anim_speed:
            for num in range(globals.rand_mass_num + 9):
                ...
                if num == 0:
                    pygame.draw.circle(screen, (255,255,0), (norm_coords(coords_table[i + globals.iter_num * 2 * num]), norm_coords(coords_table[i + globals.iter_num + globals.iter_num * 2 * num])), 10)
                elif num == 1:
                    ...
                    pygame.draw.circle(screen, (255,255,255), (norm_coords(coords_table[i + globals.iter_num * 2 * num]), norm_coords(coords_table[i + globals.iter_num + globals.iter_num * 2 * num])), 7)
                elif num == 6:
                    pygame.draw.circle(screen, (255,255,255), (norm_coords(coords_table[i + globals.iter_num * 2 * num]), norm_coords(coords_table[i + globals.iter_num + globals.iter_num * 2 * num])), 6)
                elif num == 7:
